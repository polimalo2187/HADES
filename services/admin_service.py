...
class AdminService:
    ...
    def is_admin(self, user_id: int) -> bool:
        return int(user_id) in list(Config.TELEGRAM_ADMIN_IDS)
...
_admin_singleton = AdminService()


def is_admin(user_id: int) -> bool:
    """
    Usado por telegram_bot/handlers/admin/*
    """
    return _admin_singleton.is_admin(int(user_id))
